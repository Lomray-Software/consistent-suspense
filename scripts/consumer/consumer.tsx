...
function Child() {
  const context: IConsistentSuspense = useConsistentSuspense();
  return <span id={useId()}>{context.suspenseId}</span>;
}
export const app = (
  <ConsistentSuspenseProvider store={store}>
    <Suspense {...props}>
      <Suspense.NS>
        <Child />
      </Suspense.NS>
